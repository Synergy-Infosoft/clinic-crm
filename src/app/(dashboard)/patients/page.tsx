...
import { Search, Plus, Download, User, Phone, Droplets } from 'lucide-react'
...
export default function PatientsPage() {
  ...
  const handleExport = async () => {
    const headers = ['Name', 'Age', 'Gender', 'Phone', 'Blood Group', 'Address', 'Registered On']
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-slate-50 border-b border-slate-100">
                      {['Patient', 'Age / Gender', 'Phone', 'Blood Group', 'Registered', ''].map((h) => (
                    ...
                    {filtered.length === 0 ? (
                      ...
                      filtered.map((p) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3">
                            <span className="text-sm text-slate-700">{p.blood_group || '—'}</span>
                          </td>
                          <td className="px-4 py-3">
